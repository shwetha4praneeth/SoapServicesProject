...
public abstract class EnricoCallbackHandler {
    ...
    public void receiveResultgetHolidaysForDateRange(
        soapServicesWithAxis2.EnricoStub.GetHolidaysForDateRangeResponse result) {
    }
    ...
    public void receiveResultisWorkDay(
        soapServicesWithAxis2.EnricoStub.IsWorkDayResponse result) {
    }
    ...
    public void receiveResultgetSupportedCountries(
        soapServicesWithAxis2.EnricoStub.GetSupportedCountriesResponse result) {
    }
    ...
    public void receiveResultisPublicHoliday(
        soapServicesWithAxis2.EnricoStub.IsPublicHolidayResponse result) {
    }
    ...
    public void receiveResultwhereIsPublicHoliday(
        soapServicesWithAxis2.EnricoStub.WhereIsPublicHolidayResponse result) {
    }
    ...
    public void receiveResultgetHolidaysForYear(
        soapServicesWithAxis2.EnricoStub.GetHolidaysForYearResponse result) {
    }
    ...
    public void receiveResultgetHolidaysForMonth(
        soapServicesWithAxis2.EnricoStub.GetHolidaysForMonthResponse result) {
    }
