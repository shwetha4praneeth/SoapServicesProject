...
public abstract class CalculatorCallbackHandler {
    ...
    public void receiveResultdivide(
        soapServicesWithAxis2.CalculatorStub.DivideResponse result) {
    }
    ...
    public void receiveResultadd(
        soapServicesWithAxis2.CalculatorStub.AddResponse result) {
    }
    ...
    public void receiveResultmultiply(
        soapServicesWithAxis2.CalculatorStub.MultiplyResponse result) {
    }
    ...
    public void receiveResultsubtract(
        soapServicesWithAxis2.CalculatorStub.SubtractResponse result) {
    }
